...
This project is indexed by GitNexus as **nixos-dotfiles** (1600 symbols, 1613 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
```bash
npx gitnexus analyze --skip-agents-md --embeddings
```
